...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, _______,                            _______,                            TO(_LIGHT), KC_MUTE, KC_HOME, KC_PGDN, KC_END
    ),
    ...
    [_GAME] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             TO(_BASE), _______, _______, _______, _______
    ),
    ...
    [_LIGHT] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______,                            _______,                            TO(_BASE), _______, _______, _______, _______
    ),
};
